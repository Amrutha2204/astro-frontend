...
export default function Register() {
  ...
  const pageClass =
    "relative flex min-h-screen flex-col bg-gradient-to-br from-[#fff7ed] via-[#ffedd5] to-[#fde68a] dark:from-gray-900 dark:to-gray-800";
...
`;
  ...
  return (
    ...
    focus:outline-none focus:ring-2 focus:ring-amber-400"
                ...
                <label
                  className="absolute left-4 top-2 text-xs text-gray-600 dark:text-gray-300 peer-focus:text-amber-500
    transition-all 
    ...
    focus:outline-none focus:ring-2 focus:ring-amber-400"
                ...
                <label
                  className="absolute left-4 top-2 text-xs text-amber-700 
    transition-all 
    peer-placeholder-shown:top-3.5 
    peer-placeholder-shown:text-sm 
    peer-placeholder-shown:text-gray-400 
    ...
    focus:outline-none focus:ring-2 focus:ring-amber-400"
            ...
            {!guestId && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="relative">
                  <label className="text-xs text-gray-600 mb-1 block">Birth Place *</label>
    ...
    focus:outline-none focus:ring-2 focus:ring-amber-400"
                  ...
                  <label className="absolute left-4 top-2 text-xs text-gray-600">Birth Time</label>
                </div>
              </div>
            )}
